...
public interface GitlabRestClient {
  ...
  @PUT("v4/projects/{project}/merge_requests/{prNumber}/merge?should_remove_source_branch={deleteBranch}")
  Call<Object> mergePR(
      @Header("PRIVATE-TOKEN") String token, @Path("project") String project, @Path("prNumber") String prNumber, @Query("deleteBranch") Boolean deleteBranch);
}
