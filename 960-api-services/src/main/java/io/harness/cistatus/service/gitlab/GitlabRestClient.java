...
public interface GitlabRestClient {
  ...
  Call<Object> mergePR(
      @Header("PRIVATE-TOKEN") String token, @Path("project") String project, @Path("prNumber") String prNumber, @Query("should_remove_source_branch") Boolean should_remove_source_branch);
}
