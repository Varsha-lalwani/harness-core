...
public abstract class AwsClientHelper {
    ...
    private AwsCredentialsProvider getIamRoleAwsCredentialsProvider(){
        try {
            if (System.getenv("AWS_CONTAINER_CREDENTIALS_RELATIVE_URI") != null || System.getenv("AWS_CONTAINER_CREDENTIALS_FULL_URI") != null) {
    ...
    private AwsCredentialsProvider getStsAssumeRoleAwsCredentialsProvider(AwsInternalConfig awsConfig,
                                                                          AwsCredentialsProvider primaryCredentialProvider) {
