...
public interface TemplateResourceClient {
  ...
  Call<ResponseDTO<TemplateResponseDTO>> get(@Path(value = "templateIdentifier") String templateIdentifier,
      @Query(value = NGCommonEntityConstants.ACCOUNT_KEY) @NotEmpty String accountIdentifier,
      @Query(value = NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @Query(value = NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(value = NGCommonEntityConstants.VERSION_LABEL_KEY) String versionLabel,
      @Query(value = NGCommonEntityConstants.DELETED_KEY) boolean deleted);
