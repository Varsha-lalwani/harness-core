...
public class LoginSettingsHarnessUsernamePasswordUpdateEvent implements Event {
  ...
  public Resource getResource() {
    ...
    labels.put(ResourceConstants.LABEL_KEY_RESOURCE_NAME, "LoginSettings");
    return Resource.builder()
        .identifier(loginSettingsId)
        .labels(labels)
        .type(ResourceTypeConstants.AUTH_HARNESS_USERNAME_PASSWORD)
        .build();
  }

  @Override
  public String getEventType() {
    return "HarnessUsernameAndPasswordUpdated";
  }
}
