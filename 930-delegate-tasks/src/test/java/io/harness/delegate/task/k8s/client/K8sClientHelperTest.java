...
public class K8sClientHelperTest extends CategoryTest {
  ...
  public void testEventWatchInfoFormat() {
    K8sEventWatchDTO eventWatchDTO = k8sClientHelper.createEventWatchDTO(k8sSteadyStateDTO, null, null);
  ...
  public void testStatusInfoFormat() {
    K8sStatusWatchDTO statusWatchDTO = k8sClientHelper.createStatusWatchDTO(k8sSteadyStateDTO, null, null);
