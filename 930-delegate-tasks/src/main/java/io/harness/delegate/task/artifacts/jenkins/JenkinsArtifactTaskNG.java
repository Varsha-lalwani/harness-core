...
@Slf4j
public class JenkinsArtifactTaskNG extends AbstractDelegateRunnableTask {
  @Inject JenkinsArtifactTaskHelper jenkinsArtifactTaskHelper;

  public JenkinsArtifactTaskNG(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
