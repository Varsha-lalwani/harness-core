...
public class EcsRollingDeployCommandTaskHandler extends EcsCommandTaskNGHandler {
  ...
  protected EcsCommandResponse executeTaskInternal(EcsCommandRequest ecsCommandRequest,
    ...
    try {
      ...
      List<String> ecsScalableTargetManifestContentList = ecsRollingDeployRequest.getEcsScalableTargetManifestContentList();
      List<String> ecsScalingPolicyManifestContentList = ecsRollingDeployRequest.getEcsScalingPolicyManifestContentList();
