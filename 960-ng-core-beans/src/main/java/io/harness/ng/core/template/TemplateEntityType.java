...
import static io.harness.ng.core.template.TemplateEntityConstants.DEPLOYMENT_PACKAGE;
import static io.harness.ng.core.template.TemplateEntityConstants.DEPLOYMENT_PACKAGE_ROOT_FIELD;
...
public enum TemplateEntityType {
  ...
  DEPLOYMENT_PACKAGE_TEMPLATE(
      DEPLOYMENT_PACKAGE, DEPLOYMENT_PACKAGE_ROOT_FIELD, asList(IDENTIFIER_KEY, NAME_KEY), HarnessTeam.CDP),
