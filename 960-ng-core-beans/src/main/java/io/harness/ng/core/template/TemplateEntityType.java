...
public enum TemplateEntityType {
  ...
  @JsonProperty(CUSTOM_SHELL_SCRIPT)
  CUSTOM_SHELL_SCRIPT_TEMPLATE(
      CUSTOM_SHELL_SCRIPT, CUSTOM_SHELL_SCRIPT_ROOT_FIELD, asList(IDENTIFIER_KEY, NAME_KEY), HarnessTeam.PL);
