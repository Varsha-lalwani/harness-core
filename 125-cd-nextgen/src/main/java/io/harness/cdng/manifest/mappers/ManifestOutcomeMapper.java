...
public class ManifestOutcomeMapper {
  ...
  private EcsTaskDefinitionManifestOutcome getEcsTaskDefinitionOutcome(ManifestAttributes manifestAttributes, int order) {
  ...
  private EcsServiceDefinitionManifestOutcome getEcsServiceDefinitionOutcome(ManifestAttributes manifestAttributes, int order) {
  ...
  private EcsScalableTargetDefinitionManifestOutcome getEcsScalableTargetDefinitionOutcome(ManifestAttributes manifestAttributes, int order) {
  ...
  private EcsScalingPolicyDefinitionManifestOutcome getEcsScalingPolicyDefinitionOutcome(ManifestAttributes manifestAttributes, int order) {
