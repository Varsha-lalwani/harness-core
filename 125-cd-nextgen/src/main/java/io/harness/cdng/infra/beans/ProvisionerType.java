...
import static io.harness.cdng.pipeline.NGStepType.AZ_CREATE_RESOURCE;
import static io.harness.cdng.pipeline.NGStepType.AZ_ROLLBACK_ARM_RESOURCE;
...
public enum ProvisionerType {
  ...
  private static final List<NGStepType> supportedSteps =
      Arrays.asList(TERRAFORM_APPLY, TERRAFORM_PLAN, TERRAFORM_DESTROY, TERRAFORM_ROLLBACK, CF_CREATE_STACK,
          CF_DELETE_STACK, CF_ROLLBACK_STACK, AZ_CREATE_RESOURCE, AZ_ROLLBACK_ARM_RESOURCE);
