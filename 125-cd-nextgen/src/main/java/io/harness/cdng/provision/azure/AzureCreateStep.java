...
public class AzureCreateStep extends TaskChainExecutableWithRollbackAndRbac implements AzureCreateStepExecutor {
  ...
  public void validateResources(Ambiance ambiance, StepElementParameters stepParameters) {
    ...
    AzureCreateStepConfigurationParameters spec =
        ((AzureCreateStepParameters) stepParameters.getSpec()).getConfiguration();
    AzureCreateTemplateFile azureCreateTemplateFile = spec.getTemplateFile();
