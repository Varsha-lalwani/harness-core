...
@RecasterAlias("io.harness.cdng.provision.azure.CreateARMStepInfo")
public class AzureCreateARMStepInfo
    extends AzureCreateARMStepBaseStepInfo implements CDStepInfo, Visitable, WithConnectorRef {
  @NotNull @JsonProperty("configuration") AzureCreateARMStepConfiguration createStepConfiguration;

  @Builder(builderMethodName = "infoBuilder")
  public AzureCreateARMStepInfo(ParameterField<String> provisionerIdentifier,
      ParameterField<List<TaskSelectorYaml>> delegateSelector, AzureCreateARMStepConfiguration createStepConfiguration,
      String uuid) {
  ...
  public StepType getStepType() {
    return AzureCreateARMStep.STEP_TYPE;
  }
  ...
  public SpecParameters getSpecParameters() {
    ...
    return AzureCreateARMStepParameters.infoBuilder()
