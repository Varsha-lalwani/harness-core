...
public class AzureCreateBPStepHelperTest extends CategoryTest {
  ...
  public void setUpMocks() {
    ...
    doReturn(connectorInfoDTO).when(cdStepHelper).getConnector("azure-connector", azureHelperTest.getAmbiance());
    ConnectorInfoDTO gitConnectorInfoDTO =
        ConnectorInfoDTO.builder()
            ...
            .build();
    doReturn(gitConnectorInfoDTO).when(cdStepHelper).getConnector("github-connector", azureHelperTest.getAmbiance());
