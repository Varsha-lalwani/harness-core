  ...
  public void testValidateResourcesWithInlineTemplateStore() {
    ...
    StoreConfigWrapper fileStoreConfigWrapper =
        StoreConfigWrapper.builder()
            ...
            .build();
    templateFileBuilder.setStore(fileStoreConfigWrapper);
    parameterFileBuilder.setStore(fileStoreConfigWrapper); // TODO: Change this to make sure it works with the new harness store
