...
public class AzureCreateStepTest extends CategoryTest {
    ...
    @Mock
    CDStepHelper cdStepHelper;
    @Mock
    StepHelper stepHelper;

    @Captor
    ArgumentCaptor<List<EntityDetail>> captor;
    ...
    public void testValidateResourcesWithInlineTemplateStore(){
        ...
        AzureInlineTemplateFileSpec inlineTemplateFileSpec = new AzureInlineTemplateFileSpec();
        ...
        stepParameters.setConfiguration(AzureCreateStepConfigurationParameters.builder()
                        .azureDeploymentType(AzureARMDeploymentSpec.builder()
                                ...
                                .parameters(AzureCreateParameterFile.builder()
                                        ...
                                        .build())
                                .connectorRef("connector-ref").build())
                .build());
        StepElementParameters step = StepElementParameters.builder()
                .spec(stepParameters)
                .build();
        ...
        assertThat(entityDetails.get(1).getEntityRef().getIdentifier()).isEqualTo("connector-ref");
    ...
    public void testValidateResourcesWithInlineParameters(){
        ...
        assertThat(entityDetails.get(0).getEntityRef().getIdentifier()).isEqualTo("connector-ref");
        assertThat(entityDetails.get(0).getEntityRef().getAccountIdentifier()).isEqualTo("test-account");
    }
    ...
    public void testValidateResourcesWithAllRemote(){
        AzureCreateStepParameters stepParameters = new AzureCreateStepParameters();
        AzureRemoteParametersFileSpec parametersFileSpec = new AzureRemoteParametersFileSpec();
        AzureRemoteTemplateFileSpec inlineTemplateFileSpec = new AzureRemoteTemplateFileSpec();
        StoreConfigWrapper fileStoreConfigWrapper =
                StoreConfigWrapper.builder()
                        .spec(GithubStore.builder().connectorRef(ParameterField.createValueField("parameters-connector-ref")).build())
                        .build();
        ...
        parametersFileSpec.setStore(fileStoreConfigWrapper);
        parametersFileSpec.setIdentifier("parameters-identifier");
        inlineTemplateFileSpec.setStore(templateStore);
        ...
        assertThat(entityDetails.get(2).getEntityRef().getIdentifier()).isEqualTo("connector-ref");
    ...
    public void testExecuteAzureCreateStepTask() {
        ...
        AzureARMTaskNGParameters azureTaskNGParameters = AzureARMTaskNGParameters.builder()
                ...
                .build();
        TaskChainResponse taskChainResponse = azureCreateStep.executeCreateTask(getAmbiance(), step, azureTaskNGParameters,  AzureCreatePassThroughData.builder().build());
        ...
        AzureTaskNGParameters taskNGParameters = (AzureTaskNGParameters) taskDataArgumentCaptor.getValue().getParameters()[0];
    ...
    // TODO: Missing test for the finalizeExecutionWithSecurityContext. Do this once the DelegateTask has been implemented.
}
