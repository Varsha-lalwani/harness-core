...
import static io.harness.ng.core.EnvironmentValidationHelper.checkDuplicateManifestIdentifiersWithIn;
...
public class EnvironmentResourceV2 {
  ...
  create(@Parameter(description = NGCommonEntityConstants.ACCOUNT_PARAM_MESSAGE) @NotNull @QueryParam(
    ...
    if (isNotEmpty(environmentEntity.getYaml())) {
      validateEnvGlobalManifestsOverrides(environmentEntity);
    }
  ...
  private void validateEnvGlobalManifestsOverrides(Environment environmentEntity) {
  ...
  update(@HeaderParam(IF_MATCH) String ifMatch,
    ...
    if (isNotEmpty(requestEnvironment.getYaml())) {
      validateEnvGlobalManifestsOverrides(requestEnvironment);
    }
  ...
  upsertServiceOverride(@Parameter(description = NGCommonEntityConstants.ACCOUNT_PARAM_MESSAGE) @NotNull @QueryParam(
    ...
    checkForServiceOverrideUpdateAccess(accountId, serviceOverridesEntity.getOrgIdentifier(),
        ...
        serviceOverridesEntity.getServiceRef());
    validateSvcOverrideManifestsIdsDuplication(serviceOverridesEntity);
  ...
  private void validateSvcOverrideManifestsIdsDuplication(NGServiceOverridesEntity serviceOverridesEntity) {
