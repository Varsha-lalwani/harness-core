...
public class AzureSshWinrmInstanceSyncHandler extends AbstractInstanceSyncHandler {
  ...
  public DeploymentInfoDTO getDeploymentInfo(
    ...
    List<AzureSshWinrmServerInstanceInfo> pdcServerInstanceInfos =
        (List<AzureSshWinrmServerInstanceInfo>) (List<?>) serverInstanceInfoList;
    AzureSshWinrmServerInstanceInfo pdcServerInstanceInfo = pdcServerInstanceInfos.get(0);
  ...
  public List<ServerInstanceInfo> refreshServerInstanceInfo(
    ...
    deploymentInfoDetailsDTOList.forEach(info -> {
      AzureSshWinrmDeploymentInfoDTO deploymentInfoDTO = (AzureSshWinrmDeploymentInfoDTO) info.getDeploymentInfoDTO();
      result.add(AzureSshWinrmServerInstanceInfo.builder()
