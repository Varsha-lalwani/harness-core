...
@Builder
@AllArgsConstructor
public class ServiceOverrideUpdateEvent implements Event {
  private String accountIdentifier;
  private String orgIdentifier;
  private String projectIdentifier;
  private String environmentRef;
  private String serviceRef;
  private NGServiceOverridesEntity newServiceOverride;
  private NGServiceOverridesEntity oldServiceOverride;

  @JsonIgnore
  @Override
  public ResourceScope getResourceScope() {
    return new ProjectScope(
        accountIdentifier, newServiceOverride.getOrgIdentifier(), newServiceOverride.getProjectIdentifier());
  }
  ...
  public String getEventType() {
    return OutboxEventConstants.SERVICE_OVERRIDE_UPDATED;
  }
}
